...
namespace PulseButton
{
	public class PulseButton : Button
	{
		...
		[Browsable(true), Category("Appearance"), DefaultValue(typeof(Color), "CornflowerBlue")]
		...
		public PulseButton()
		{
			...
			this.ShapeType = PulseButton.Shape.Round;
		...
		protected virtual void DrawCenter(Graphics g)
		{
			if (base.Enabled)
			{
				using (LinearGradientBrush linearGradientBrush = new LinearGradientBrush(this.centerRect, this.ButtonColorTop, this.ButtonColorBottom, LinearGradientMode.Vertical))
				{
		...
		protected virtual void DrawReflex(Graphics g)
		{
			using (GraphicsPath graphicsPath = new GraphicsPath())
			{
				...
				using (LinearGradientBrush linearGradientBrush = new LinearGradientBrush(bounds, Color.FromArgb(30, Color.White), Color.FromArgb(60, Color.White), -90f))
				{
